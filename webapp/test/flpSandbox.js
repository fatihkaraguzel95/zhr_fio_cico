					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Schnellbuchung App",
									"targetURL": "#zhrfiocico-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zhrfiocico-display": {
								"semanticObject": "zhrfiocico",
								"action": "display",
								"description": "Schnellbuchung App",
								"title": "Schnellbuchung App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zhrfiocico",
									"url": sap.ui.require.toUrl("zhrfiocico")
								}
							}
						}
					}
